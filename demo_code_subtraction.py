# This python code demonstrates the computational model for subtracting
...
b = 0.3 # Variable encoded in code B
...
axes[0].set_title(r"Code $v_O$", fontsize=16)
...
axes[1].set_title(r"Code $v_P$", fontsize=16)
...
axes[2].set_title(r"Code $v_O - v_P$", fontsize=16)
...
ax.plot(x, hA, label=r"Code $v_O$", linewidth=2, color='0.8')
ax.plot(x, theo_A, linestyle='--', linewidth=2, color='0.8')
ax.plot(x, hB, label=r"Code $v_P$", linewidth=2, color='0.6')
ax.plot(x, theo_B, linestyle='--', linewidth=2, color='0.6')
ax.plot(x, hC, label=r"Code $v_O - v_P$", linewidth=2, color='0')
ax.plot(x, theo_C, linestyle='--', linewidth=2, color='0')
ax.legend(fontsize=14)
ax.tick_params(axis='both', which='both', labelsize=14)
ax.set_xlabel("Preferred Speed [Arbitrary Unit]", fontsize=14)
...
print(f"Correlation coefficient for nearby preferred values: {correlation_coefficient}")
...
# Compute Pearson correlation coefficient
correlation_coefficient, p_value = pearsonr(C[n1_C,:], C[n2_C,:])
print(f"Correlation coefficient for far preferred values: {correlation_coefficient}")
